...
ggplot() +
  geom_line(data = pdata$Bayern, aes(x = Meldedatum, y = Hospitalisierung, col = Altersgruppe), alpha = 0.5) +
  scale_color_manual(values=c("#ff0000", "#56ff00", "#000fff")) +
  geom_point(data = 
               pdata$Bayern[pdata$Bayern$Meldedatum %in% c(as.Date("2022-01-03"), 
                                                           as.Date("2022-01-10")),], 
