...
levels(list_of_dfs$Bayern$Altersgruppe) <- c("00-04", "05-14", "15-34", "35+","35+","35+")
...
bay_gam <- gam(Hospitalisierung ~ s(index, k = 50, bs = "ps") + s(Neuerkrankung, bs = "ps", k = 20) + Altersgruppe +
                 s(Kalenderwoche, bs = "cc", k = 50) +
                 s(Altersgruppe, bs = "fs", k = 5) + 
                 ti(Altersgruppe, Neuerkrankung, bs = c("fs", "cs")),
