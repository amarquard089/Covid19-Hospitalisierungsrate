...
ggplot(p_rate_100) +
  geom_line(aes(x = as.Date(paste("1",Kalenderwoche, Kalenderjahr, sep = "-"), format = "%u-%W-%Y"), y = hosprate)) + theme_minimal() + xlab("Kalenderwochen") + ylab("Hospitalisierungsrate")
```
...
plot(p_rate_abs$Hospitalisierung ~ p_rate_abs$Meldedatum, type = "l", 
     xlab = "Datum", ylab = "Hospitalisierungen")
```
...
plot(p_hosp_inf$hosprate ~ p_hosp_inf$Meldedatum, type = "l",
     xlab = "Datum", ylab = "Hospitalisierungsrate")
