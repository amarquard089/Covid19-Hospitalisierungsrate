...
ggplot(p_rate_abs) +
  geom_line(aes(y = Hospitalisierung, x = Meldedatum), size = 1.25) + 
     xlab("Meldedatum") + ylab("Hospitalisierungen") + theme_minimal() +
  theme(text = element_text(size = 25))
...
ggplot(p_hosp_inf) +
  geom_line(aes(y = hosprate, x = Meldedatum), size = 1.25) +
     xlab("Meldedatum") + ylab("Hospitalisierungsrate") + theme_minimal() +
  theme(text = element_text(size = 25))
...
ggplot(p_bl_age) +
  ...
  theme(text = element_text(size = 25))  + ylab("Hospitalisierungsrate") +
