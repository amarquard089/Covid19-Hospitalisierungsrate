...
png(filename="../Bilder/Hospitalisierung_nach_Altersgruppen.png", width= 1200, height = 540)
...
ggplot(final_df_wo_impfung) +
  geom_histogram(aes(x = sum_hosp_nowcast),bins = 40, color = "#e34a33", fill = "#fdbb84") +
  theme_minimal() +
