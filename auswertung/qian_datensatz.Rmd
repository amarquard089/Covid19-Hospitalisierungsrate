...
1. Zusammenfassung inzidenz nach Anmeldedatum, Hospitalisierung, impfquote und Lockdown: "fin_datensatz"
...
hospitalisierung_clean <- 
  ...
  filter(Weekday == "Mon") %>% # "周一" bedeutet "Montag"
...
impfung_clean_sum_new <- 
  ...
  filter(Weekday == "Sun") %>% # ”周日“ bedeutet "Sonntag"
